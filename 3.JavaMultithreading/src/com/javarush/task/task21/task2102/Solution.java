...
Сравниваем модификаторы
 ...
 if (Modifier.isPublic(specificModifier) != Modifier.isStatic(allModifiers)) { return true; } return false; Сделал с 1 попытки, но.... Прочитал про класс Modifier и до сих пор сижу думаю... как? наверное плохо выспался...
*/
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        if (Modifier.isPublic(specificModifier) != Modifier.isStatic(allModifiers)) {
            return true;
        }
        return false;
    }
